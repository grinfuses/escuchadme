...
<div id="footer">
  ...
  <div class="footer_credit">
   ...
   <?php endif; ?>
    ...
    <div id="copyright">
     <p class="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <?php print $site_name; ?> </p> <p class="credits"> <?php print t('Realizado por'); ?>  <a href="http://www.javiernaranjo.es" target="_blanck">Javier Naranjo</a></p>
    <div class="clear"></div>
    </div>
  </div>
  </div>
